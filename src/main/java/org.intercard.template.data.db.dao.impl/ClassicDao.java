...
public class Classic extends KartenTechnologien {
	...
	private String kartentechnologie = "Classic";
	...
	public String getKartentechnologie() {
		return kartentechnologie;
	}

	public void setKartentechnologie(String kartentechnologie) {
		this.kartentechnologie = kartentechnologie;
	}
