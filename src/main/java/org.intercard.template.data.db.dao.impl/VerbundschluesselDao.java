...
@NamedQueries({ @NamedQuery(name = "findSchluessel", query = "SELECT s FROM Verbundschluessel s") })
public class Verbundschluessel implements IEntity {
	...
	// return "Verbundschluessel[id="
	// + id
	// + ","
	// + (hauptboerse == true ? "hauptboerse=" + true + ", " : "")
	// + (oeffenDaten == true ? "oeffenDaten=" + true + ", " : "")
	// + (mtknr_trw_daten == true ? "mtknr_trw_daten=" + true + ", "
	// : "")
	// + (bibliotheksnr == true ? "bibliotheksnr=" + true + ", " : "")
	// + (zutrittsnr == true ? "zutrittsnr=" + true : "") + "]";
	// }

	@Override
	public String toString() {
		/** gibt nur das aus, was true ist */
		return "Verbundschluessel[id=" + id + ","
				+ (hauptboerse == true ? "hauptboerse" + ", " : "")
				+ (oeffenDaten == true ? "oeffenDaten" + "," : "")
				+ (mtknr_trw_daten == true ? "mtknr_trw_daten" + ", " : "")
				+ (bibliotheksnr == true ? "bibliotheksnr" + ", " : "")
				+ (zutrittsnr == true ? "zutrittsnr" : "") + "]";
	}
